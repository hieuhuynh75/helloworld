<%-- 
    Document   : fontcss
    Created on : Sep 25, 2015, 10:59:48 PM
    Author     : Cesc
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <p>Cheese is a remarkably versatile food, available in literally hundreds of
            varieties with different flavors and textures.</p>
        <h2>Welsh Rarebit</h2>
        <ol>
            ...
            <li>When thick and smooth, pour over each piece of toast spreading it to the
